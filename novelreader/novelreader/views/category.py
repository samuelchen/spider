...
class CategoryView(TemplateView, BaseViewMixin):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['top_a'] = {
            ...
            "novels": list_hot_novels_by_category(category, page_items=10)
        }

        context['tops_b'] = [
            {"title": "推荐榜", "subtitle": category, "icon": "fa fa-thumbs-up",
             "novels": list_recommend_novels_by_category(category, page_items=10)},
            {"title": "收藏榜", "subtitle": category, "icon": "fa fa-star",
             "novels": list_favorite_novels_by_category(category, page_items=10)},
        ]
        return context
